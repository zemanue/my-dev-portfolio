...
const projects = [
    ...
    },
    {
        ...
        images: ["/telecom-erp/telecom-.png", "/telecom-erp/telecom-editar-factura.png", "/telecom-erp/telecom-facturas.png"],
        link: "https://github.com/zemanue/proyecto2",
        skills: ["HTML", "CSS", "PHP", "JavaScript", "MySQL", "MVC", "Bootstrap"]
    },
    {
        title: "Novelas Visuales Bimfloat",
        tag: "🎮 Publicadas en Nintendo Switch",
        description: "Novelas visuales infantiles desarrolladas con Unity y el plugin Naninovel, para su publicación en Nintendo Switch. Configuración de escenas, prefabs, animaciones y scripts en C#. Uso de IA generativa (ChatGPT, Gemini e IA integrada en Krita) para creación de imágenes e historias.",
...
function ProjectCard({ project }) {
    return (
        <div key={project.title} className="flex flex-col gap-4 border rounded-lg text-zinc-900 dark:text-zinc-100 bg-gray-100 dark:bg-zinc-800/80 shadow-2xl p-7 border-zinc-200 dark:border-zinc-700">
            ...
            <img src={project.images[0]} alt={project.title} className="h-48 w-full rounded-md object-cover hover:scale-112 transition-transform duration-300" />
            {/* Tag */}
